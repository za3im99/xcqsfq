...
- ${config.prefix}sd [ID SERVER SPAM] - لـ تحديد سيرفر الاسبام
                  
- ${config.prefix}cd [ID CHANNEL SPAM] - لـ تحديد روم الاسبام
...
// ======= [ Reload JSON - END   ] ======== //
 ...
 // جمــيع الحقوق محفوظة لدي "za3im"
// ======= [ Console LOG    ] ======== //
client.on('ready', () => {
...
message.channel.send("#rep "+"<@700414812345335828>")
  }
